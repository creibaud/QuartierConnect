export default {
    ...
    pages: {
        ...
        services: {
            title: "Services",
            description: "The directory of services and businesses in your neighborhood.",
        ...
        events: {
            ...
            emptyDescription: "Organize the first gathering of your neighborhood.",
    ...
    adminPages: {
        ...
        dashboard: {
            ...
            quickLinks: {
                ...
                incidents: { label: "Incidents", desc: "Moderation and statuses" },
                neighborhoods: { label: "Neighborhoods", desc: "Create, edit, delete" },
        ...
        events: {
            ...
            emptyDescription: "Create the first event to liven up neighborhood life.",
            titleColumn: "Title",
            dateColumn: "Date",
            placeColumn: "Place",
        ...
        communityVotes: {
            ...
            emptyTitle: "No votes",
            emptyDescription: "Launch a consultation to gather residents' opinions.",
            closed: "Vote closed",
