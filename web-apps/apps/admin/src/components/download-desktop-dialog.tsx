...
function BrandIcon({ path, className }: LogoProps & { path: string }) {
    return (
        <svg
            viewBox="0 0 24 24"
            fill="currentColor"
...
const WindowsLogo = ({ className }: LogoProps) => (
    <BrandIcon path={WINDOWS_PATH} className={className} />
);
const AppleLogo = ({ className }: LogoProps) => (
    <BrandIcon path={APPLE_PATH} className={className} />
);
const LinuxLogo = ({ className }: LogoProps) => (
    <BrandIcon path={LINUX_PATH} className={className} />
);
const JavaLogo = ({ className }: LogoProps) => (
